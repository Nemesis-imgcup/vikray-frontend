...
import "./homecomp.css";
import { Image2, Image1, Image3 } from './compassets';
...
const ComponentA = () => {
    return (
        <div className='pt-[10vh] '>
            <div className='m-7'>
                <div className='text-3xl text-[#F8F872] pb-5 font-bold pl-80'>
                ...
                <div className='tt3'>For any products you buy, mint your own nft for your product, so that you can<br></br> have your 
                    taste of choice in both realverse and metaverse together</div>
                <Image3/>
                <div className='text-3xl text-[#F8F872] pt-96 pb-5 font-bold pl-80'>
