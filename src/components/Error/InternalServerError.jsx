...
const InternalServerError = () => {
  return (
    <div> <div className="text-[#F8F872] text-center mt-[25vh] font-extrabold text-[9vw] tracking-wide">
    505
  </div>
  ...
  <div className=" text-center text-[#F8F872] font-normal text-2xl mt-4">
    The page you are looking for have some technical issues <br /> or something went technically wrong !
  </div>
